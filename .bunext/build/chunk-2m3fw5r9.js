...
var useLoadingVersion = () => import_react3.useContext(VersionContext);
...
function useReload() {
  const reload = import_react3.useContext(ReloadContext);
  return reload;
}
function useRouteState(key, initial) {
  return import_react3.useReducer((_old, newvalue) => {
...
var RouterHost = ({
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(ReloadContext.Provider, {
    ...
    children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV(VersionContext.Provider, {
      value: version,
      children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV(SessionProvider, {
        children: current
      }, undefined, false, undefined, this)
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
...
export { __toESM, __commonJS, require_react, require_react_dom, getRouteMatcher, require_jsx_dev_runtime, match, useLoadingEffect, useReloadEffect, ReloadContext, RouterHost, NextJsLayoutStacker };
